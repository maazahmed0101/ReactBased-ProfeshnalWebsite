// Local mock video data. Every video uses the same generated sample clip
// (public/media/sample.webm + sample.mp4) and a generated SVG thumbnail
// (public/thumbs). Swap `videoSrc` / `thumbnail` for real assets when available.
const thumb = (n) => `/thumbs/thumb-${String(n).padStart(2, "0")}.svg`;

const SRC = {
  webm: "/media/sample.webm",
